...
class source:
    def __init__(self):
        ...
        ## User Specific ##
        self.name=control.setting('emby.name2')
        self.user=control.setting('emby.user2')
        self.password=control.setting('emby.pass2')
        self.serverip=control.setting('emby.serverip2')
        self.server_port=control.setting('emby.port2')
