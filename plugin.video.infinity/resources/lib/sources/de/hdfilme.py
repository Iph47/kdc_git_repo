        ...
        try:
            ...
            for server in ['']: # nur default Server
                ...
                for quality, url in streams_all:
                    ...
                    if "1080" in quality:
                        sources.append({'source': 'HDFILME.CX', 'quality': '1080p', 'language': 'de',
                                        'url': url, 'direct': True, 'debridonly': False})
                    elif "720" in quality:
                        sources.append({'source': 'HDFILME.CX', 'quality': '720p', 'language': 'de',
                                        'url': url, 'direct': True, 'debridonly': False})
                    else:
                        sources.append({'source': 'HDFILME.CX', 'quality': 'SD', 'language': 'de',
                                        'url': url, 'direct': True, 'debridonly': False})
