...
class source:
    def __init__(self):
        self.priority = 1
        self.language = ['de']
        self.domains = ['kinoz.to', 'kinox.si', 'kinox.sx', 'kinox.nu', 'kinox.sg', 'kinos.to', 'kinox.fun', 'kinox.fyi', 'kinox.wtf', 'kinox.tv', 'kinos.to', 'kinox.ag', 'kinox.to', 'kinox.me', 'kinox.am', 'kinox.nu', 'kinox.pe', 'kinox.sg', 'kinox.nu', 'kinox.si']
