...
class player(xbmc.Player):
    ...
    def preload(self):
        try:
            ...
            control.execute('RunPlugin(plugin://%s)' % ('plugin.video.infinity/?action=preload&imdb=' + imdb + '&tvshowtitle=' + tvshowtitle + '&year=' + year + '&tvdb=' + tvdb + '&episode=' + episode + '&season=' + season))
        except: pass
