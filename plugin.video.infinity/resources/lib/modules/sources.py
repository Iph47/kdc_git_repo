...
class sources:
    ...
    def addItem(self, title):
        ...
        if 'thumb' in meta:thumb = json.dumps(meta['thumb'])
        elif 'poster' in meta:thumb = json.dumps(meta['poster'])
        elif 'poster3' in meta:thumb = json.dumps(meta['poster3'][0])
        else:thumb =  control.addonFanart()

        if 'poster' in meta:poster = json.dumps(meta['poster'])
        elif 'poster3' in meta:poster = json.dumps(meta['poster3'][0])
        else:poster = control.addonPoster()

        if 'banner' in meta:banner = json.dumps(meta['banner'])
        elif 'fanart2' in meta:banner = json.dumps(meta['fanart2'][0])
        else:banner = control.addonBanner()

        if 'fanart' in meta:fanart = json.dumps(meta['fanart'])
        elif 'fanart2' in meta:fanart = json.dumps(meta['fanart2'][0])
    ...
    def sourcesFilter(self):
        ...
        no_captcha = control.setting('no.captcha')
        if no_captcha == '': no_captcha = 'false'
        ...
        ## https://github.com/infinity/plugin.video.infinity/issues/119
        ...
        #removing debrid only function, re-use for  https://github.com/infinity/plugin.video.infinity/issues/120
        ...
        if quality in ['0']: filter += [i for i in self.sources if i['quality'] == '4K' and 'debrid' in i and (('info' in i and not 'subbed' in i['info'] )or not 'info' in i)]
        if quality in ['0']: filter += [i for i in self.sources if i['quality'] == '4K' and not 'debrid' in i and (('info' in i and not 'subbed' in i['info'] )or not 'info' in i)]
        if quality in ['0']: filter += [i for i in self.sources if i['quality'] == '4K' and 'debrid' in i and 'info' in i and 'subbed' in i['info']]
        if quality in ['0']: filter += [i for i in self.sources if i['quality'] == '4K' and not 'debrid' in i and 'info' in i and 'subbed' in i['info']]
        
        if quality in ['0', '1']: filter += [i for i in self.sources if i['quality'] == '1440p' and 'debrid' in i and (('info' in i and not 'subbed' in i['info'] )or not 'info' in i)]
        if quality in ['0', '1']: filter += [i for i in self.sources if i['quality'] == '1440p' and not 'debrid' in i and (('info' in i and not 'subbed' in i['info'] )or not 'info' in i)]
        if quality in ['0', '1']: filter += [i for i in self.sources if i['quality'] == '1440p' and 'debrid' in i and 'info' in i and 'subbed' in i['info']]
        if quality in ['0', '1']: filter += [i for i in self.sources if i['quality'] == '1440p' and not 'debrid' in i and 'info' in i and 'subbed' in i['info']]
        
        if quality in ['0', '1', '2']: filter += [i for i in self.sources if i['quality'] == '1080p' and 'debrid' in i and (('info' in i and not 'subbed' in i['info'] )or not 'info' in i)]
        if quality in ['0', '1', '2']: filter += [i for i in self.sources if i['quality'] == '1080p' and not 'debrid' in i and (('info' in i and not 'subbed' in i['info'] )or not 'info' in i)]
        if quality in ['0', '1', '2']: filter += [i for i in self.sources if i['quality'] == '1080p' and 'debrid' in i and 'info' in i and 'subbed' in i['info']]
        if quality in ['0', '1', '2']: filter += [i for i in self.sources if i['quality'] == '1080p' and not 'debrid' in i and 'info' in i and 'subbed' in i['info']]

        if quality in ['0', '1', '2', '3']: filter += [i for i in self.sources if i['quality'] == '720p' and 'debrid' in i and (('info' in i and not 'subbed' in i['info'] )or not 'info' in i)]
        if quality in ['0', '1', '2', '3']: filter += [i for i in self.sources if i['quality'] == '720p' and not 'debrid' in i and (('info' in i and not 'subbed' in i['info'] )or not 'info' in i)]
        if quality in ['0', '1', '2', '3']: filter += [i for i in self.sources if i['quality'] == '720p' and 'debrid' in i and 'info' in i and 'subbed' in i['info']]
        if quality in ['0', '1', '2', '3']: filter += [i for i in self.sources if i['quality'] == '720p' and not 'debrid' in i and 'info' in i and 'subbed' in i['info']]
        ...
        if no_captcha == 'true':
            filter = [i for i in self.sources if  'info' in i and 'Recaptcha' in i['info']]
            self.sources = [i for i in self.sources if not i in filter]
        ...
        for i in range(len(self.sources)):
            ...
            if (self.sources[i]['provider']=="emby"
                or self.sources[i]['provider']=="emby2"
                or self.sources[i]['provider']=="emby3"
                or self.sources[i]['provider']=="emby4"
                or self.sources[i]['provider']=="emby5"
                ...
                or self.sources[i]['provider']=="gdrive"
                    ):
                if not prem_identify == 'nocolor':
                    self.sources[i]['label'] = ('[COLOR %s]' % (prem_identify)) + label.upper() + '[/COLOR]'
    ...
    def getConstants(self):
        self.itemProperty = 'plugin.video.infinity.container.items'
