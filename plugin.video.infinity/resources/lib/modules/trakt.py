...
V2_API_KEY = '57fcae3f77ae1a9788537c817723d965a4851d20a9ae812717ec7aba8cb2ef48'
CLIENT_SECRET = 'eb48dc5c1d8c4c8f0c8df44be7d71a5a4b92da119622ece106845c91c73468b8'
...
def __getTrakt(url, post=None):
    ...
    try:
        ...
        result = client.request(url,close=False, post=post, headers=headers, output='extended', error=True)
