...
class navigator:
    ...
    def tools(self):
        ...
        self.addDirectoryItem("[B]INFINITY[/B]: Bibliothek", 'libraryNavigator', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem("[B]INFINITY[/B]: Anzeige-Typen", 'viewsNavigator', 'tools.png', 'DefaultAddonProgram.png')
        if control.setting('FaultLogger.enabled') == 'true':
            self.addDirectoryItem("[B]INFINITY[/B]: Fehlerhafte Provider anzeigen", 'showFaultyProvider', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem("[B]INFINITY[/B]: Suchverlauf leeren", 'clearCacheSearch', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem("[B]INFINITY[/B]: Cache leeren", 'clearCache', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem("[B]INFINITY[/B]: Indexseiten-Cache leeren", 'clearSources', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem("[B]INFINITY[/B]: Metadaten-Cache leeren", 'clearCacheMeta', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem("[B]INFINITY[/B]: Alle Caches leeren", 'clearCacheAll', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem("[B]INFINITY[/B]: Google Drive-Berechtigung", '_add_account&content_type=video', 'tools.png', 'DefaultAddonProgram.png')
    ...
    def library(self):
        self.addDirectoryItem("[B]INFINITY[/B]: Bibliothek aktualisieren", 'updateLibrary&query=tool', 'library_update.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem("[B]INFINITY[/B]: Film-Ordner", control.setting('library.movie'), 'movies.png', 'DefaultMovies.png',
                              isAction=False)
        self.addDirectoryItem("[B]INFINITY[/B]: TV-Serien-Ordner", control.setting('library.tv'), 'tvshows.png', 'DefaultTVShows.png', isAction=False)
    ...
    def views(self):
        try:
            ...
            select = control.selectDialog([i[0] for i in items], "[B]INFINITY[/B]: Anzeige-Typen")
    ...
    def infoCheck(self, version):
        try:
            control.infoDialog('infinity.ch/forum/', "HILFE", time=5000,
                               sound=False)
            return '1'
        except:
            return '1'
