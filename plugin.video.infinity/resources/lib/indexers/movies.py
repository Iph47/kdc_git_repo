...
class movies:
    def __init__(self):
        ...
        self.theaters_link = 'https://www.imdb.com/search/title/?title_type=feature,tv_movie,documentary&release_date=date[365],date[0]&num_votes=500,&adult=include'
...
#             Folgende 2 Punkte werden nicht gefiltert!
    ...
    def movieDirectory(self, items):
        ...
        watchedMenu = "In Trakt [I]Gesehen[/I]" if trakt.getTraktIndicatorsInfo() == True else "In Infinity [I]Gesehen[/I]"

        unwatchedMenu = "In Trakt [I]Ungesehen[/I]" if trakt.getTraktIndicatorsInfo() == True else "In Infinity [I]Ungesehen[/I]"
